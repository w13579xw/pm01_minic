...
from engineai_rl_lab.utils.export_deploy_cfg import export_deploy_cfg
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    _rsl_rl_ver = _meta.version("rsl-rl-lib")
    handle_deprecated_rsl_rl_cfg(agent_cfg, _rsl_rl_ver)
